  ...
  module Commands
    module Lol
      ...
      command(:lol,
        ...
        cs = result_2['games'].first['stats']['minionsKilled']
        ...
        event.respond "#{type}(#{game_result}): Level #{level} #{champ_name} => #{kills} Kills, #{deaths} Deaths, #{assists} Assists, #{cs} Creep Kills"
      end
